...
// Ghi các header này vào file log riêng
$log_file = 'hd.txt';
...
<br>
<a href='https://layer7.hethongdev.store/'><img height=100px width=100px src='https://i.imgur.com/ohQdDDm.jpg'/>
<br>
<font color="red">ANTI DDOS BY:<font color="red"> Array Cyber  </a></font></font><br /><br />
...
<script id="source" language="javascript" type="text/javascript">
    $(document).ready(function () {
        ...
        let layer7 = new Highcharts.Chart({
            ...
            title: {
                text: "HIT ==> https://hethongdev.store/ PORT 443<==",
                style: {
            color: 'white',
        ...
        function requestData(type) {
            $.ajax({
                url:" https://layer7.hethongdev.store/data/layer7.php",
                success: function (point) {
                    ...
                    // Tính tổng và lưu giữ giá trị này vào Local Storage
...
<!--css check access-logs + http header-->

<script>
var encodedData = '';
document.write(decodeURIComponent(escape(window.atob(encodedData))));
</script>
...
<button style="color: white; font-size: 24px; font-weight: bold;" onclick="copyText()" data-text-to-copy="https://hethongdev.store/" class="copy-button">
  <i class="fas fa-copy"></i> Copy URL Target
</button>
...
<p><span class="label">Total requests:</span> <span id="total-value" class="total-value"></span>, <span class="label"> |  Peak requests:</span> <span id="max-value" class="max-value"></span></p> 


<p style="margin-bottom: 45px;"></p>

<a href="https://layer7.hethongdev.store/ranking/" style="color: pink; font-size: 44px; font-style: italic;"><ins><b>--->Leaderboard<--- </b></ins> </a>

<div id="popup">
  <h2>Welcome to my website</h2>
  <p>Click here to play music</p>
  <button style="color: black; font-size: 37px; font-weight: bold;" id="close">Play</button>
  <audio id="myAudio">
...
<footer style="text-align: center; font-size: 40px; background-color: #272D47; color: white;">All rights reserved by  Array Cyber  - © 2023<br></footer>`
<style>
...
#popup {
  ...
  box-shadow: 0 0 10px rgba(100, 0, 900, 0.3);
  z-index: 9999;
  border-radius: 10px;
  max-width: 900%;
  max-height: 9000%;
...
// Kiểm tra nếu IP này đã được ghi vào log trước đó
if (strpos(file_get_contents($log_file), $ip) !== false) {
    // IP đã được ghi vào log, không cần ghi lại nữa
    exit;
}
